...
const [isSubmitting, setIsSubmitting] = useState(false);
  const submitHandler = async(e) => {
      ...
      // axios.post(`${import.meta.env.VITE_BASE_URL}/captains/login`, NewCaptain)
      // .then((response) => {
    ...
    <div className="p-7  h-screen flex flex-col justify-between">
      <div>
        ...
        <p className="text-center">Join a fleet?<Link to='/captain-Singup' className='text-blue-600'>Register as a Captain</Link></p>
      </div>
      <div>

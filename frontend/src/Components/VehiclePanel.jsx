...
//   return (
//     <div>
//          <div  ref={vehiclePanelRef} className="fixed w-full z-10 bottom-0 px-4 py-15 pt-14  bg-white">
//         <VehiclePanel setVehiclePanelOpen={setVehiclePanelOpen}/>
//       </div>
//        <h4 className="text-center p-1 w-[90%] absolute top-0  font-semibold" onClick={()=>
//           setVehiclePanelOpen(false)
//         }><i className=" text-gray-400 text-3xl ri-arrow-down-wide-line"></i></h4>
//         <div   className=" flex border-2  border-gray-300 active:border-black  w-full  mb-2 rounded-xl p-3  items-center justify-between " tabIndex={1}>
...
//           </div>
//           <h2 className="text-xl font-medium">193.20Rs</h2>
//         </div>
//         <div  className=" flex border-2  border-gray-300 active:border-black  w-full  mb-2 rounded-xl p-3 items-center justify-between ">
//           <img  className="h-15"src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_956,h_637/v1649231091/assets/2c/7fa194-c954-49b2-9c6d-a3b8601370f5/original/Uber_Moto_Orange_312x208_pixels_Mobile.png" alt="" />
//           <div className="  ml-3 w-1/2">
...
//           </div>
//           <h2 className="text-xl font-medium">100.20Rs</h2>
//         </div>
//         <div  className=" flex border-2 border-gray-300 active:border-black  w-full  mb-2 rounded-xl p-3 items-center justify-between ">
...
//             <p className="font-normal text-xs">Affordable, Auto</p>
//           </div>
//           <h2 className="text-xl font-medium">90.20Rs</h2>
//         </div>
...
const VehiclePanel = ({ vehiclePanelOpen, setVehiclePanelOpen , setConfirmRideOpen }) => {
  const vehiclePanelRef = useRef(null);
  ...
  return (
    ...
    >
      ...
      className="flex border-2 border-gray-300 active:border-black w-full mb-2 rounded-xl p-3 items-center justify-between">
        <img className="h-15" src="https://clipart-library.com/2023/Uber_Auto_312x208_pixels_Mobile.png" alt="" />
        <div className="ml-3 w-1/2">
          <h4 className="font-bold text-base">Auto <span><i className="ri-user-3-fill"></i>1</span></h4>
          <h5 className="font-medium text-sm">5 mins away</h5>
          <p className="font-normal text-xs">Affordable, Auto rides</p>
        </div>
        <h2 className="text-xl font-medium">65.20Rs</h2>
      </div>
    </div>
  );
};
